...
function proptomia.LogInfo(...)
    MsgC(color_wblue, "Proptomia | ", color_gray, "[", color_blue, " INFO ", color_gray, "]\t", color_white, ...)
end
function proptomia.LogWarn(...)
    MsgC(color_wblue, "Proptomia | ", color_gray, "[", color_yellow, " WARN ", color_gray, "]\t", color_white, ...)
end
function proptomia.LogError(...)
    MsgC(color_wblue, "Proptomia | ", color_gray, "[", color_red, " ERROR ", color_gray, "]\t", color_white, ...)
    debug.Trace()
end
